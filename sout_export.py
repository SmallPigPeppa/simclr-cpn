...
FLAGS.set_default('train_batch_size', 128)
FLAGS.set_default('train_epochs', 601)
FLAGS.set_default('learning_rate', 0.)
...
# --model_dir=/share/lwz/saved_model/simclr_google
# --use_tpu=False
