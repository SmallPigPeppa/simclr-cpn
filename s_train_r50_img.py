...
import data_without_imagenetsub as data_lib
import metrics
...
FLAGS.set_default('train_batch_size',128*NUM_GPUS)
FLAGS.set_default('train_epochs',1000)
FLAGS.set_default('temperature',0.1)
FLAGS.set_default('learning_rate',0.005)
FLAGS.set_default('learning_rate_scaling','sqrt')
FLAGS.set_default('weight_decay',1e-4)
FLAGS.set_default('dataset','imagenet2012')
FLAGS.set_default('image_size',224)
FLAGS.set_default('eval_split','validation')
FLAGS.set_default('data_dir', '/share/datasets/tensorflow_datasets')
FLAGS.set_default('model_dir','/share/lwz/simclr_model/r50_imagenet')
