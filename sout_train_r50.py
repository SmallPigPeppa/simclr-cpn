...
import data_without_cifar100 as data_lib
import metrics
import model_semi as model_lib
...
FLAGS.set_default('train_mode','pretrain')
FLAGS.set_default('train_batch_size',512*8)
FLAGS.set_default('train_epochs',2000)
FLAGS.set_default('learning_rate',0.005)
FLAGS.set_default('weight_decay',1e-4)
FLAGS.set_default('temperature',0.5)
FLAGS.set_default('image_size',32)
FLAGS.set_default('dataset','imagenet_resized/32x32')
FLAGS.set_default('eval_split','validation')
FLAGS.set_default('resnet_depth',50)
FLAGS.set_default('use_blur',False)
FLAGS.set_default('color_jitter_strength',0.5)
FLAGS.set_default('model_dir','/data/home/wzliu/code/simclr32_3/r50_continue/r50')
FLAGS.set_default('use_tpu',False)
FLAGS.set_default('width_multiplier',1)
# FLAGS.set_default('lineareval_while_pretraining', False)
# FLAGS.set_default('learning_rate_scaling','sqrt')
FLAGS.set_default('cache_dataset', True)
FLAGS.set_default('data_dir', '/data/home/wzliu/tensorflow_datasets')
