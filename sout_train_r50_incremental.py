...
FLAGS.set_default('train_batch_size',512*4)
FLAGS.set_default('train_epochs',3000)
FLAGS.set_default('learning_rate',1e-5)
...
FLAGS.set_default('model_dir','/data/home/wzliu/code/simclr32_3/r50_incremental')
