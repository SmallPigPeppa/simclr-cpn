...
LR=0.0001
NUM_EPOCHS=100000
PATH='/data/home/wzliu/code/simclr32_3/r50/saved_model/0'
...
x_train=np.load('data_pretrained/r50/x_train.npy')
x_test=np.load('data_pretrained/r50/x_test.npy')
y_train=np.load('data_pretrained/r50/y_train.npy')
y_test=np.load('data_pretrained/r50/y_test.npy')
