...
FLAGS.set_default('learning_rate',0.3)
FLAGS.set_default('weight_decay',1e-4)
FLAGS.set_default('temperature',0.5)
FLAGS.set_default('image_size',64)
FLAGS.set_default('dataset','imagenet_resized/64x64')
...
FLAGS.set_default('model_dir','/data/home/wzliu/code/simclr32_3/r50_64')
