...
np.save('../../data_pretrained/r50_cifar100_new/x_train', x_train_pretrained)
np.save('../../data_pretrained/r50_cifar100_new/x_test', x_test_pretrained)
np.save('../../data_pretrained/r50_cifar100_new/y_train', y_train)
np.save('../../data_pretrained/r50_cifar100_new/y_test', y_test)
